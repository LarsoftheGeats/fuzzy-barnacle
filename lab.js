...
//console.log(totalPopulation(propValues))//Test log returned 10 as expected
...
// console.log(ingredients(foodValues))
...
user.email="bryan.smith@devmounta.in"//typo?  Just copied the directions
//console.log(user)
